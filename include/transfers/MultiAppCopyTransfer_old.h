...
class MultiAppCopyTransfer_old;

template <>
InputParameters validParams<MultiAppCopyTransfer_old>();

/**
 * Copy the value to the target domain from the nearest node in the source domain.
 */
class MultiAppCopyTransfer_old : public MultiAppFieldTransfer_old
{
public:
  static InputParameters validParams();

  MultiAppCopyTransfer_old(const InputParameters & parameters);
