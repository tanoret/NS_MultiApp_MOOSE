...
class NormalizationAuxOlder;

template <>
InputParameters validParams<NormalizationAuxOlder>();
 ...
 */
class NormalizationAuxOlder : public AuxKernel
{
public:
  static InputParameters validParams();

  NormalizationAuxOlder(const InputParameters & parameters);
