...
#include "NavStokesPressurePoisson.h"
#include "MooseMesh.h"

registerMooseObject("AirfoilAppApp", NavStokesPressurePoisson);

InputParameters
NavStokesPressurePoisson::validParams()
{
...
NavStokesPressurePoisson::NavStokesPressurePoisson(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
NavStokesPressurePoisson::computeQpResidual()
{
  // Laplacian part
...
Real
NavStokesPressurePoisson::computeQpJacobian()
{
  return _grad_phi[_j][_qp] * _grad_test[_i][_qp];
}

Real
NavStokesPressurePoisson::computeQpOffDiagJacobian(unsigned jvar)
{
