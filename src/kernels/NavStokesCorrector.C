...
#include "NavStokesCorrector.h"
#include "MooseMesh.h"

registerMooseObject("AirfoilAppApp", NavStokesCorrector);

InputParameters
NavStokesCorrector::validParams()
{
...
NavStokesCorrector::NavStokesCorrector(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
NavStokesCorrector::computeQpResidual()
{
...
Real
NavStokesCorrector::computeQpJacobian()
{
...
Real
NavStokesCorrector::computeQpOffDiagJacobian(unsigned jvar)
{
