...
#include "NormalizationAuxOlder.h"

registerMooseObject("MooseApp", NormalizationAuxOlder);

defineLegacyParams(NormalizationAuxOlder);

InputParameters
NormalizationAuxOlder::validParams()
{
...
NormalizationAuxOlder::NormalizationAuxOlder(const InputParameters & parameters)
  : AuxKernel(parameters),
    _src(coupledValueOlder("source_variable")),
...
Real
NormalizationAuxOlder::computeValue()
{
