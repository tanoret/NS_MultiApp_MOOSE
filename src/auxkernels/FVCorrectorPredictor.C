...
#include "FVCorrectorPredictor.h"
#include "MooseMesh.h"
...
registerMooseObject("AirfoilAppApp", FVCorrectorPredictor);

InputParameters
FVCorrectorPredictor::validParams()
{
...
FVCorrectorPredictor::FVCorrectorPredictor(const InputParameters & parameters)
  :
    // Base class
...
Real
FVCorrectorPredictor::computeValue()
{
  /// Diffusion term
