...
// MOOSE includes
#include "MultiAppCopyTransfer_old.h"
#include "FEProblemBase.h"
#include "MultiApp.h"

registerMooseObject("AirfoilAppApp", MultiAppCopyTransfer_old);

defineLegacyParams(MultiAppCopyTransfer_old);

InputParameters
MultiAppCopyTransfer_old::validParams()
{
  InputParameters params = MultiAppFieldTransfer_old::validParams();
...
MultiAppCopyTransfer_old::MultiAppCopyTransfer_old(const InputParameters & parameters)
  : MultiAppFieldTransfer_old(parameters),
...
void
MultiAppCopyTransfer_old::execute()
{
